var bridge = {
    ...
    call: function (b, a, c) {
        ...
        if (window._dsbridge) e = _dsbridge.call(b, a);
            ...
            void 0 !== window.cc &&
                void 0 !== window.cc.sys &&
                void 0 !== window.cc.sys.__audioSupport &&
                void 0 !== window.cc.sys.__audioSupport.context &&
                (("suspended" !== window.cc.sys.__audioSupport.context.state && "interrupted" !== window.cc.sys.__audioSupport.context.state) || window.cc.sys.__audioSupport.context.resume());
        }
